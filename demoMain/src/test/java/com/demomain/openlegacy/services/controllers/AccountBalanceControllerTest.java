...
/**
 *  A test which invokes AccountBalance web service via an http client.
...
public class AccountBalanceControllerTest {
	...
	private String url = "http://localhost:8080/demoMain/services/accountbalance";

	@BeforeClass
	public static void initialize() {
		queryParams.add("rqAccountnum", "");
		queryParams.add("rqCoid", "");
		queryParams.add("rqAccounttype", "");
	}
	...
	@Test
	public void testPostAccountBalance(){
		Client client = new Client();
		WebResource resource = client.resource(url);

		String input = "{\"rqAccountnum\":\"\"\"rqCoid\":\"\"\"rqAccounttype\":\"\"}";
	...
	@Test
	public void testGetAccountBalanceCache() throws Exception {
